...
Model Context Protocol (MCP) servers and domain-specific AI tools for Israeli data sources and services. Part of the [Israeli AI Ecosystem](README.md) resource list.
