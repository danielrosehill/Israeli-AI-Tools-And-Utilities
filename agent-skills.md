...
| [Israel-Agent-Skills](https://github.com/danielrosehill/Israel-Agent-Skills-Plugin) | Claude Code plugin — general Israel/Hebrew-specific agent skills (Hebrew translation, typography, emergency readiness, regional lookups). Shopping is out of scope; see `Claude-Israel-Shopping-Plugin`. | ![](https://img.shields.io/github/stars/danielrosehill/Israel-Agent-Skills-Plugin?style=social) |
